# Implements ***** Cellular Automata (first defined in https://archive.bridgesmathart.org/2016/bridges2016-127.html) in Golly.
#
...
g.setrule("TCA45" + brickstring + "-T%dC%d" % (turningrule, crossingrule))
g.show('Created '+"TCA45" + brickstring + "-T%dC%d.rule" % (turningrule, crossingrule)+' and selected that rule.')
